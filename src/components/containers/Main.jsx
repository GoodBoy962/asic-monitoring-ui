...
const Bar = ({classes}) => (
  <AppBar className={classes.appBar}>
    <Toolbar>
      <Typography variant="title" color="inherit" noWrap>Мониторинг асиков</Typography>
    </Toolbar>
  </AppBar>
);
  ...
  <Drawer variant="permanent" classes={{ paper: classes.drawerPaper }}>
    <div>
      ...
      <MenuList>
        ...
        <MenuItem onClick={ History.push.bind(History, '/workers') }>
          <ListItemIcon>
            <Star/>
          </ListItemIcon>
          <ListItemText>Асики</ListItemText>
        </MenuItem>
      </MenuList>
    </div>
  </Drawer>
